      ...
      <main className="game-layout">
        ...
        <div className="side-column side-column-left">
          ...
          <div className="glass-panel game-controls-panel">
            ...
            {gameState === 'IDLE' ? (
              <button className="neon-button primary-btn v-menu-btn" onClick={startGame}>
                <Play size={16} /> <span className="btn-txt">시작하기</span>
              </button>
            ) : gameState === 'PLAYING' ? (
              <div className="menu-btn-group">
                <button className="neon-button pause-big-btn v-menu-btn" onClick={togglePause} title="일시정지 (ESC)">
                  <Pause size={16} /> <span className="btn-txt">일시정지 (ESC)</span>
                </button>

                <button
                  className="neon-button secondary-btn side-restart-btn v-menu-btn"
                  onClick={startGame}
                  title="게임 다시 시작"
                >
                  <RotateCcw size={14} /> <span className="btn-txt">재시작</span>
                </button>

                <button
                  className="end-game-btn small-end-btn v-menu-btn"
                  onClick={endGame}
                  title="현재 게임 종료 및 점수 기록"
                >
                  <Square size={11} /> <span className="btn-txt">게임종료</span>
                </button>
              </div>
            ) : gameState === 'PAUSED' ? (
              <div className="menu-btn-group">
              ...
              <button className="neon-button primary-btn v-menu-btn" onClick={startGame}>
                <RotateCcw size={16} /> <span className="btn-txt">다시 시작</span>
              </button>
            )}
          </div>
        </div>
